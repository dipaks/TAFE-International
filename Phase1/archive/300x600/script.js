 function windowLoad() {
    ...
    devDynamicContent.International_Dynamic_Sheet1[0].Background_Image.Url = "background_300x600.jpg";
    ...
    devDynamicContent.International_Dynamic_Sheet1[0].Hero_Image.Url = "heroimage_300x600.png";
	...
	document.getElementById('clickLayer').addEventListener('click', function()
	 {
        ...
        var tl=new TimelineMax({repeat:0, repeatDelay:5});
		 tl
				...
				.to('#copy_2', 0.8, {autoAlpha:1, x:365, rotationZ: 0.01},"-=1")
			    .to('#heroimage', 0.8, {autoAlpha:1, x:-200, rotationZ: 0.01},"-=0.5")
			
				
				.to('#copyA_a', 0.8, {clip:"rect(0px, 164px, 150px, 0px)"},"-=0.0")
				.to('#copy_2', 0.8, {x:-290, delay:1},"-=0.0")
				.to('#copyA_a', 1.3, {x:-300},"-=0.8")
				.to('#copyA_b', 0.8, {autoAlpha:1, x:-300, rotationZ: 0.01},"-=1")
				.to('#copyA_b', 1, {x:-570, delay:1.5},"-=0.0")
				.to('#copyA_c', 0.8, {autoAlpha:1,  x:-340, rotationZ: 0.01},"-=1")
				.to('#copyA_c', 0.8, {x:-580, delay:1.5},"-=0.0")
				
				.to('#line', 0.8, {clip:"rect(0px, 230px, 80px, 0px)"},"-=0.5")
