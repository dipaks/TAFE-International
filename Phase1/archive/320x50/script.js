 function windowLoad() {
    ...
    devDynamicContent.International_Dynamic_Sheet1[0].Background_Image.Url = "background_320x50.jpg";
    ...
    devDynamicContent.International_Dynamic_Sheet1[0].Hero_Image.Url = "heroimage_320x50.png";
	...
	document.getElementById('clickLayer').addEventListener('click', function()
	 {
        ...
        var tl=new TimelineMax({repeat:0, repeatDelay:5});
		 tl
				...
				.to('#copy_2', 0.8, {autoAlpha:1, y:54, rotationZ: 0.01},"-=0.8")
				.to('#heroimage', 0.8, {autoAlpha:1, y:-50, rotationZ: 0.01},"-=0.5")
			
				
				.to('#copyA_a', 0.8, {clip:"rect(0px, 80px, 80px, 0px)"},"-=0.0")
				.to('#copy_2', 0.8, {y:-50, delay:1},"-=0.0")
				.to('#copyA_a', 0.8, {y:70},"-=0.8")
				.to('#copyA_b', 0.8, {autoAlpha:1, y:58, rotationZ: 0.01},"-=0.5")
				.to('#copyA_b', 1, {y:160, delay:1.5},"-=0.0")
				
				.to('#copyA_c', 0.8, {autoAlpha:1, y:41, rotationZ: 0.01},"-=0.5")
				.to('#copyA_c', 1, {y:100, delay:1.5},"-=0.0")
